...
def viewexpense():
    ...
    l=Label(root,text="Date\t  Name\t  Title\t  Expense",font=('arial',15,'bold'),bg="blue2",fg="white")
...
dateLable=Label(root,text="Date", font=('arial',15,'bold'),bg="blue2",fg="white",width=12)
dateLable.grid(row=0,column=0,padx=7,pady=7)

dateEntry=DateEntry(root,width=12,font=('arial',15,'bold'))
dateEntry.grid(row=0,column=0,padx=7,pady=7)

Name=StringVar()
nameLabel=Label(root,text="Name",font=('arial',15,'bold'),bg="Blue2",fg="white",width=12)
nameLabel.grid(row=1,column=0,padx=7,pady=7)

NameEntry=Entry(root, text="Name",font=('arial',15,'bold'))
NameEntry.grid(row=1,column=1,padx=7,pady=7)

Title=StringVar()
titleLabel=Label(root, text="Title",font=('arial',15,'bold'),bg="Blue2",fg="white",width=12)
...
Expense=IntVar()
expenseLabel=Label(root,text="Expense",font=('arial',15,'bold'),bg="Blue2",fg="white",width=12)
...
submitbtn=Button(root,command=submitexpense, text="submit",font=('arial',15,'bold'),bg="Blue2",fg="white",width=12)
submitbtn.grid(row=4,column=0,padx=13,pady=13)

viewtn=Button(root,command=viewexpense, text="view expenses",font=('arial',15,'bold'),bg="Blue2",fg="white",width=12)
